...
pushd Lyrics_CN
install -m0644 * %{buildroot}/%{_datadir}/apps/amarok/scripts/lyrics_cn
...
%changelog
* Fri Aug 17 2007 Kevin Deldycke <kev@coolcavemen.com> 1.4.7-2mdv2007.1
- Backported from cooker to Mandriva 2007.1
- Enable MySQL and PostgreSQL support

* Thu Aug 16 2007 Funda Wang <fundawang@mandriva.org> 1.4.7-1mdv2008.0
+ Revision: 64501
- New verison 1.4.7
