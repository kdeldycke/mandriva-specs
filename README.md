...
This is an archive of the Mandriva RPMs sources I was distributing in my personal package repository. These packages used to be available at `http://kevin.deldycke.com/static/repository/mandriva/` but the [**repository has now been retired**](http://kevin.deldycke.com/2013/02/mandriva-repositories-retired/ ).
