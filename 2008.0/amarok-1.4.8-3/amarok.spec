...
%define develscripts %mklibname -d %{name}-scripts
...
Source1:	Lyrics_CN-0.5.2.tar.bz2
...
#(nl)# Upstream patches of the upcoming amarok 1.4.9  ####
...
# install source1
mkdir -p %{buildroot}/%{_datadir}/apps/amarok/scripts/lyrics_cn/dict
pushd Lyrics_CN
cp -a * %{buildroot}/%{_datadir}/apps/amarok/scripts/lyrics_cn
chmod 0755 %{buildroot}/%{_datadir}/apps/amarok/scripts/lyrics_cn/Lyrics_CN
popd
...
%changelog
* Sat Jan 26 2008 Kevin Deldycke <kev@coolcavemen.com> 1:1.4.8-3mdv2008.0
- Rebuild against latest libgpod 0.6.0

* Sat Jan 26 2008 Kevin Deldycke <kev@coolcavemen.com> 1:1.4.8-2mdv2008.0
- Backported from 2008.1 to Mandriva 2008.0
- Enable MySQL and PostgreSQL support

* Mon Dec 17 2007 Nicolas Lécureuil <neoclust@mandriva.org> 1:1.4.8-1mdv2008.1
+ Revision: 131480
- New version 1.4.8
