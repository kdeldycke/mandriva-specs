%define name    qlc
%define version 3.0.0.trunk.r1278
...
%changelog
* Sat Aug 15 2009 Kevin Deldycke <kevin@deldycke.com> 3.0.0.trunk.r1278-1mdv2009.1
- Upgrade to latest SVN trunk revision r1278
