...
#(nl) From svn:  SVN commit 557632
Patch5:   amarok-1.4.1-fix-lastfm-conflict.patch
...
%patch5 -p1 -b .fix_conflict_with_lastfm

%build
export QTDIR=%_prefix/lib/qt3

# Fix for the conflict with upstream lastfm
cp amarok/src/lastfm.protocol amarok/src/amaroklastfm.protocol
...
kdedesktop2mdkmenu.pl %{name} "Multimedia/Sound" %buildroot%{_datadir}/applications/kde/%{name}.desktop %buildroot%{_menudir}/%{name} x11 Amarok
